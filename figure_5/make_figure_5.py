...
width.scatter(df['l_bed'], df['width'], clip_on = False, zorder = 3,
...
depth.scatter(df['l_bed'], df['depth'], color = 'r', 
...
slope.scatter(df['l_bed'], df['slope'], label = 'bed slope', clip_on = False, 
              zorder = 3, edgecolor = 'k', alpha = 1, marker = 's', s = markersize,
              c = '#fdb863')
slope.scatter(df['l_bed'], df['e_slope'], label = 'energy slope', clip_on = False, 
...
f_ratio.scatter(df['l_bed'], df['fr/f0'], color = '#b8e186', clip_on = False, 
...
fig2.savefig('fig_sweep_bed_cover_' + run_name +'_lores.png', dpi = 200)
