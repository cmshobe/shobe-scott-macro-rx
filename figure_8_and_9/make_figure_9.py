...
#width_short.set_ylim(width_min, width_max)
...
#width_long.set_ylim(width_min, width_max)
...
depth_legend = depth.legend(handles[::-1], labels[::-1], bbox_to_anchor=(1.0,0.5), loc = 'lower right', 
                   bbox_transform=depth.transAxes, framealpha = 1, 
                   edgecolor = 'k')
...
depth_hfp.annotate('below bank', xy = (0.55, 0.25), xytext = (0.77, 0.25),
...
#                                     lw = 2.0, color = 'k'))
depth_hfp.annotate('overbank', xy = (0.8, 0.62), xytext = (0.8, 0.52),
                   xycoords = 'axes fraction', fontsize = 12, ha = 'center',
                   va = 'top', 
                   bbox = dict(boxstyle='square', fc = 'white', color = 'k'),
                   arrowprops = dict(arrowstyle='-[, widthB=3, lengthB=0.5', 
                                     lw = 2.0, color = 'k'))
...
#slope_short.set_xlim(xmin_short, xmax_short)
#slope_short.set_ylim(slope_min, slope_max)
...
#plt.tight_layout()
fig2.savefig('figure_9_long_trajectories_hires.png', dpi = 1000, bbox_inches = 'tight')
fig2.savefig('figure_9_long_trajectories_lores.png', dpi = 200, bbox_inches = 'tight')
